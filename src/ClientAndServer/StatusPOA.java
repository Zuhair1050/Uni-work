...
/**
* ClientAndServer/StatusPOA.java .
...
public abstract class StatusPOA extends org.omg.PortableServer.Servant
 implements ClientAndServer.StatusOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // ClientAndServer/Status/message
       {
         String $result = null;
         $result = this.message ();
         out = $rh.createReply();
  ...
  private static String[] __ids = {
    "IDL:ClientAndServer/Status:1.0"};
